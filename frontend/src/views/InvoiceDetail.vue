<template>
  <main class="detail">
    ...
    <div class="details">
      ...
      <div class="adress">
        <p class="adress-street">{{ invoice.address.address }}</p>
      ...
      <div class="client-adress">
        <p class="client-street">{{ invoice.clientAdress.address }}</p>
        <p class="client-city">{{ invoice.clientAdress.city }}</p>
        <p class="client-postcode">{{ invoice.clientAdress.postcode }}</p>
        <p class="client-country">{{ invoice.clientAdress.country }}</p>
      </div>
...
export default {
  ...
  methods: {
    ...
    ...mapActions(["deleteInvoice", "markInvoice"]),
